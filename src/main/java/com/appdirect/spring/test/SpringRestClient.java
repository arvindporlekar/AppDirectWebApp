...
import com.appdirect.spring.model.User;
...
public class SpringRestClient {
	...
	private static void getUser(AuthTokenInfo tokenInfo) {
		...
		ResponseEntity<User> response = restTemplate.exchange(
				REST_SERVICE_URI + "/user/1" + QPM_ACCESS_TOKEN + tokenInfo.getAccess_token(), HttpMethod.GET, request,
				User.class);
	...
	private static void updateUser(AuthTokenInfo tokenInfo) {
		...
		HttpEntity<Object> request = new HttpEntity<Object>(user, getHeaders());
		ResponseEntity<User> response = restTemplate.exchange(
				REST_SERVICE_URI + "/user/1" + QPM_ACCESS_TOKEN + tokenInfo.getAccess_token(), HttpMethod.PUT, request,
				User.class);
